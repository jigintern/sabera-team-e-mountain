...
object Geodesy {
     ...
     *
     * **地上の的にとって、大気差の在り処はここだけ。**
     * [altitudeDeg] が返す仰角は**すでに見かけの仰角**で、これに
     * [jp.jig.glasses.sample.kmp.geo.apparentAltitudeDeg]（星のための大気差）を重ねてはいけない。
     * どちらも同じ「大気が光を曲げる」を数えているので、掛けると二重になる
     * （地平線で +0.48°・白山の 2.43° で +0.26°、しかも低いほど強く効くので
     * 稜線の形そのものが縦に 8% 縮む）。星は大気の外に居るので向こうは正しい。
     */
